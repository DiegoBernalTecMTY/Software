# MNA — Agente de Citas: Project Summary

**Production-Ready Booking & Appointments Web Application**

## 🎯 Project Overview

MNA (Agente de Citas) is a modern, accessible booking and appointments management web application built with React, TypeScript, and Tailwind CSS. The application features both traditional CRUD operations and innovative natural language command processing for creating appointments conversationally.
