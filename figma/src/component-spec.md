# MNA Component Specification

This document details all custom components in the MNA application, their props, variants, and usage guidelines.
...
- **Logo & Branding:** Calendar icon with "MNA" text
